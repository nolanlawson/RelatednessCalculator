...
public enum BasicRelation {
	...
	GreatAuntOrUncle (new Relation(new CommonAncestor(3, 2), new CommonAncestor(3, 2))),
	GreatNieceOrNephew (new Relation(new CommonAncestor(2, 3), new CommonAncestor(2, 3))),
